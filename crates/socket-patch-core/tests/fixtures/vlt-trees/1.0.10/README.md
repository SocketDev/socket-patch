# vlt 1.0.10 installed layout

`listing.json` is the on-disk layout real vlt 1.0.10 produced, captured with
...
- "slc-git": "git+https://github.com/isaacs/string-locale-compare.git#v1.1.0"
